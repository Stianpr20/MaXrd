...
SyntaxInformation @ TransformAtomicDisplacementParameters = {"ArgumentsPattern"
     -> {_, _.}};
...
TransformAtomicDisplacementParameters[crystal_, transformation_:"EquivalentIsotropic"
    ...
    Block[{ADPs, cartesianConverter, cartesianADPs},
        ...
        If[!MemberQ[{"CartesianConverter", "EquivalentIsotropic"}, transformation
            ...
            Message[TransformAtomicDisplacementParameters::InvalidTransformation,
                 transformation];
            Abort[]
        ];
...
(* a. Transform ADPs to Cartesian basis -- returns function 
    *)
        ...
        If[transformation === "EquivalentIsotropic",
            ...
            ADPs = Lookup[$CrystalData[crystal, "AtomData"], "DisplacementParameters",
                 0.];
...
$CartesianConverterMaker[crystal_] :=
    Module[
        ...
        latticeReciprocal = GetCrystalMetric[crystal, "Category" -> "LatticeParameters",
             "Space" -> "Reciprocal", "Units" -> False];
        ...
        cartesianConverterFactory[adp_] :=
            (
                ...
                (* Alternatively: see '_cell.convert_Uiso_to_Uij' *)(*
                     ...
                     ADPs * 
    {{1,#3,#2},{#3,1,#1},{#2,#1,1}} &@@ Cos @ latticeReciprocal
        \[LeftDoubleBracket]4;;6\[RightDoubleBracket] 
*)];
