Options @ MergeSymmetryEquivalentReflections = {"ToStandardSetting" -> True};

SyntaxInformation @ MergeSymmetryEquivalentReflections = {"ArgumentsPattern" -> {_, _, OptionsPattern[]}};
...
MergeSymmetryEquivalentReflections[group_String, hkl_List, OptionsPattern[]] :=
    Block[
        ...
        merged = DeleteDuplicatesBy[input, Sort @ SymmetryEquivalentReflections[sg, #]&];
